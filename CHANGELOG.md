...
## [1.68.0](https://github.com/SayonaraQ/bedolaga-cabinet/compare/v1.67.0...v1.68.0) (2026-09-01)


### Features

* **a11y,i18n:** more modal focus-traps + Telegram theme/language sync ([0caba3d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/0caba3dffb34927fc1d9744dc5e51c3869675551))
* **a11y:** cross-platform hardening + modal focus-trap from impeccable audit ([8e0b63b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/8e0b63bac893485752a5837f2f82599dcf752702))
* **a11y:** dialog semantics + focus trap for the onboarding tour ([5c7d4b4](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5c7d4b4888c230ebf9595106b479194946bbae2d))
* add admin legal pages api client and display mode types ([e979aa8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/e979aa8863e32cd141722dbc1690fac12bfedeae))
* add display mode selector to info page editor ([04cbbb5](https://github.com/SayonaraQ/bedolaga-cabinet/commit/04cbbb5e5182ee3996d62356917c7786132ea8ac))
...
* add system pages admin section ([0d6a85a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/0d6a85a4f91ec07b1f87207e1502e30fbf3aeb2c))
* **admin-remnawave:** add node/xray version icons like the panel ([1b1046b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1b1046bb5c5caf43e55f3bb5915962a05319cc23))
* **admin-remnawave:** auto-refresh overview, responsive mobile grids, wide sub-requests ([ff3dbfa](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ff3dbfaa25c0a3bb08d2e16344b024fa659fcfab))
* **admin-remnawave:** enrich panel stats UI and fix nodes-online display ([b8be989](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b8be98939abb03ce9c8be24bc96890367c8443d3))
* **admin-remnawave:** meaningful icons for users-by-status cards ([7ca9c04](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7ca9c043ddfc5393efcd6c00fc5677d60b6dbe55))
* **admin-remnawave:** merge Traffic into Nodes as a per-node accordion ([6c9a77d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/6c9a77d419d7358308836efbe7614efad5932971))
* **admin-remnawave:** panel-style node rows with live metrics ([08f12da](https://github.com/SayonaraQ/bedolaga-cabinet/commit/08f12daa400b0117d1502d260a405f4e9bd40f13))
* **admin-remnawave:** provider favicon, mobile node card, meaningful icons ([9309643](https://github.com/SayonaraQ/bedolaga-cabinet/commit/9309643b7e200da10e6960e6a298d1dad26c7246))
...
* **admin:** quick amounts editor in payment method settings ([bb8b823](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bb8b823b3778ac31538cb980c7323f7ca33d212a))
...
* **admin:** show common placeholders group in email template editor ([8b2501d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/8b2501d908b17a4f5402571da778e0cb793cc934))
...
* **auth,a11y:** Telegram CloudStorage token recovery + blocking-screen a11y ([f311602](https://github.com/SayonaraQ/bedolaga-cabinet/commit/f31160208a5b5e872c78e8e0f5ee9a65d1a66928))
...
* **balance:** per-method quick amounts on top-up page ([25784db](https://github.com/SayonaraQ/bedolaga-cabinet/commit/25784dbe181a515a3c340f086fda347f77b86031))
...
* **cabinet:** bulletproof Close button + kill the /login flash on the service-unavailable screen ([7413837](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7413837fafdf7346054b72bbd05a1c42c4e38bd2))
...
* **cabinet:** migrate all icons to the panel's Phosphor set ([d0e0b6b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/d0e0b6b7e3fd29a533636b397ed5021a75074615))
* **cabinet:** premium redesign of all 5 full-screen blocking states ([782568e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/782568e091fbe636c9f3136002f5b230089cdc04))
* **cabinet:** recoverable "service unavailable" screen when the backend is unreachable ([ac8a0fc](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ac8a0fc41aff4065fdf1dde0bbc47694bfd1f010))
* **connected-accounts:** email-merge confirmation via emailed one-time code ([3224320](https://github.com/SayonaraQ/bedolaga-cabinet/commit/322432009502e6b983f286747e1d4840123fb7db))
...
* **desktop-header:** group nav into a centered segmented capsule ([7de9b3b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7de9b3b51be095da15a9035c98d0aefa4b526838))
...
* **gift:** transferable gift claim — buyer share link + recipient claim page ([db31d39](https://github.com/SayonaraQ/bedolaga-cabinet/commit/db31d395cd70055da8b0cbf697fc70173b45401a))
* hide info tabs by display mode visibility ([39758a1](https://github.com/SayonaraQ/bedolaga-cabinet/commit/39758a18b04c7af2bb0d629cda69e1b978196672))
* **icons:** add node/gift glyphs to the central barrel ([872f731](https://github.com/SayonaraQ/bedolaga-cabinet/commit/872f73157faff53dc75d6689c1ea75d5e4150d6f))
* **landing-stats:** rebuild charts on shared components + add funnel & breakdowns ([78c633f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/78c633ff548e893978f3bb7213475501a5562d56))
...
* **landing:** фолбэк на глобальную тему кабинета, когда у лендинга своя не задана ([0859583](https://github.com/SayonaraQ/bedolaga-cabinet/commit/085958342e023ecf5811208644a1db54029ab67b))
...
* **sales-stats:** вкладка «Оплаты» — success-rate и неудачные покупки ([436d9f8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/436d9f860c89a4012c57a9689b11abdff1572332))
* **sales-stats:** дельты период-к-периоду на карточках сводки ([a685e54](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a685e542aa1e3863b25cac52af6e12edebc6e3c7))
* **sales-stats:** душевные карточки с иконками + фикс скачка при смене периода ([dfc7768](https://github.com/SayonaraQ/bedolaga-cabinet/commit/dfc7768a403c9d8ff91a79cea8df9207b1855d8c))
* **sales-stats:** иконки на карточках во всех вкладках ([80ac631](https://github.com/SayonaraQ/bedolaga-cabinet/commit/80ac63102b91a3aced5b3b599c5da05b6803bffa))
* **sales-stats:** карточки возвратов в сводке ([bd12113](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bd12113294c92379fc7fee6d4c25f1d73e3de856))
* **sales-stats:** конкретика в сводке ([3adda6f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/3adda6fa032e3d105b8b7836b478f68f4c5e6d9f))
* **sales-stats:** пресет «Этот месяц» (с 1-го числа) и он же по умолчанию ([9a05f23](https://github.com/SayonaraQ/bedolaga-cabinet/commit/9a05f23a04358affca5faa0acb5cd81911372136))
* **sales-stats:** разбивка допов по пакетам тоже на BreakdownList ([bb97ee8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bb97ee8430c6073ea872b08dea7733c0f9a46f27))
* **sales-stats:** читаемые разбивки и stacked-бары, иконки платёжек, выручка ([a75f42d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a75f42d056afe7183cf070cf0d9e9cb88630f94a))
...
* **ui:** заменить все нативные date-инпуты на DateField ([016da9f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/016da9f638ca4a7ecec35e0d77c0e851bc3b8808))
...
* **ui:** тёмный DateField на react-day-picker вместо нативного input ([edd2d25](https://github.com/SayonaraQ/bedolaga-cabinet/commit/edd2d25024989a0b2d7888b82fa2f13dce60b63e))
...
* **yandex-conv:** forward CID through remaining paid API methods ([574da67](https://github.com/SayonaraQ/bedolaga-cabinet/commit/574da67ca059427731dca6e0af69977cad746107))
* **yandex-conv:** forward CID through subscription purchase requests ([1b82280](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1b82280853d5938efeaf1d8517b937e8cbde5583))


### Bug Fixes

* **a11y:** announce form-level errors via role=alert in Login + ResetPassword ([92ec9c3](https://github.com/SayonaraQ/bedolaga-cabinet/commit/92ec9c3c4288f409b2f280b2d2f47d4082ccb251))
* **a11y:** announce Login form-level error via role=alert ([7e9e51b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7e9e51ba5a4d364413e2f47e09323ab0dc375d7d))
* **a11y:** aria-label on icon-only buttons (Subscription copy + InstallationGuide back/QR) ([9f06526](https://github.com/SayonaraQ/bedolaga-cabinet/commit/9f065262385b8abf357fd8b3cff34e21b472bbc7))
* **a11y:** associate referral form labels with their inputs ([1b40c38](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1b40c3856d189be84ac8dfa60f5988b5fa8b805e))
* **a11y:** associate Support ticket form labels with their inputs ([90888db](https://github.com/SayonaraQ/bedolaga-cabinet/commit/90888db48c0f620fb9ac223a31257416a1dd87d9))
* **a11y:** label associations for AdminCampaignCreate fields ([4d18be8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/4d18be848d8ad6174a3c81ffcb3959269ee24534))
* **a11y:** label associations for AdminCampaignEdit fields ([6f66cb6](https://github.com/SayonaraQ/bedolaga-cabinet/commit/6f66cb67590b7fada4b6e79f875630c684380fed))
* **a11y:** label associations for AdminInfoPageEditor fields ([a489724](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a4897243ba7c8d046a485437e2e85d81b9b9c4a7))
* **a11y:** label associations for AdminNewsCreate fields ([fefc52f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/fefc52fb203ffc73c730ba3ebc7ae941440ec814))
* **a11y:** label associations for AdminPromocodeCreate fields ([a635ca2](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a635ca23161c3e2865e4f4f82a7e1e79bd283513))
* **a11y:** label associations for AdminPromoGroupCreate + AdminPinnedMessageCreate ([5a8195f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5a8195f83fb78604af260fc127f4085742d3750f))
* **a11y:** label associations for AdminPromoOfferTemplateEdit fields ([1ec6d7e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1ec6d7e9794b7630377065c7d1aa6ff02b9a1be5))
* **a11y:** label associations for AdminServerEdit fields ([d42fcfa](https://github.com/SayonaraQ/bedolaga-cabinet/commit/d42fcfa5dd77a8663b1e4b761efe579f09328712))
* **a11y:** label associations for AdminTariffCreate fields ([e1b48c1](https://github.com/SayonaraQ/bedolaga-cabinet/commit/e1b48c1ccb66ad44019c3fc4e537527b99dcd4d4))
* **a11y:** radiogroup semantics for AdminInfoPageEditor button groups ([30c4c2e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/30c4c2ecc67915df90c5eb5d0d1f5cd1233ca7cc))
* **a11y:** radiogroup semantics for AdminPromoOfferSend button groups ([581a2ff](https://github.com/SayonaraQ/bedolaga-cabinet/commit/581a2ffb529f59bb8493a702ef2180cb4598b59b))
* **a11y:** radiogroup semantics for Campaign bonus-type selector ([27ba507](https://github.com/SayonaraQ/bedolaga-cabinet/commit/27ba50747ac1fa6aab190560c4691a1284f9f8a7))
* **a11y:** switch semantics for admin form toggles ([7b0a72d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7b0a72db5b4e13a5ddbb9e24bb405253501ebe5f))
* **a11y:** switch semantics for user-flow toggles ([491f48a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/491f48a331b80fa84e0ac82e3fd0341557adbff5))
...
* **admin-bulk-actions:** plug stale-closure bug in columns useMemo ([7817243](https://github.com/SayonaraQ/bedolaga-cabinet/commit/78172432539b66e3ed4d57dce708b6ce5dae0052))
* **admin-bulk-actions:** trap focus + label modal dialog (a11y) ([bc34e65](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bc34e65aace9bda183ca33360a36c2b9471726bb))
* **admin-remnawave:** add RAM/CPU icons to node metrics like the panel ([297d75a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/297d75a92c30d650c2a5eee4c3785b2365d6d094))
* **admin-remnawave:** lay node metrics in 3 fixed rows (processor/traffic/versions) ([43acb70](https://github.com/SayonaraQ/bedolaga-cabinet/commit/43acb70ab96ad70b7f66f26db32b05f6dc18349f))
* **admin-remnawave:** node metrics 3-rows on mobile, original single row on desktop ([97d4367](https://github.com/SayonaraQ/bedolaga-cabinet/commit/97d436721ac5c180fd82af40e1267ffd97deda9f))
* **admin-remnawave:** resolve provider favicon from site URL ([bd5e39f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bd5e39fa56591a06ac94c5b6c6f095215c57ffe0))
* **admin-remnawave:** scope the mobile orphan-fill to small screens only ([493de23](https://github.com/SayonaraQ/bedolaga-cabinet/commit/493de23a1dc678f33af7878dbc5cd981daebb3c5))
* **admin-remnawave:** truncate long tags in node traffic accordion ([1ef4b21](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1ef4b21614a10d23bd2531bc9e66a79414864c50))
* **admin-remnawave:** причесать иконки в карточках статистики ([7efe069](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7efe069be077a35e3538908d24bd68d11407d513))
* **admin-wheel:** unify prize-order banner buttons + drop hardcoded i18n fallbacks ([e4b3c86](https://github.com/SayonaraQ/bedolaga-cabinet/commit/e4b3c8640bdbcf18430c736b8027abb51ce612cc))
* **admin-wheel:** unify statistics rendering + fill config UI gaps ([5de43c1](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5de43c1071aa1fabb63ce70989afde1e5f431059))
...
* **admin:** rework email template editor ([#667043](https://github.com/SayonaraQ/bedolaga-cabinet/issues/667043)) ([ac75a80](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ac75a806d93374313d8b65d77d6250c87c07a096))
* **admin:** surface clipboard copy failures instead of swallowing ([576b4d5](https://github.com/SayonaraQ/bedolaga-cabinet/commit/576b4d5601f4ee9d242786297390c7717337d733))
...
* **balance:** align quick amounts edge cases with bot behavior ([9219885](https://github.com/SayonaraQ/bedolaga-cabinet/commit/92198854b2efbc213d7bb4a951f85f249d9c9bb2))
...
* **broadcasts:** показывать «Партнёрка» вместо сырого ключа referrals в превью ([c24ae00](https://github.com/SayonaraQ/bedolaga-cabinet/commit/c24ae0039cc554176aef2085606748d8e21ec3e5))
...
* **bulk-actions:** drop unused ChevronDownIcon import ([a8df415](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a8df41593133133bafd0f14a4c78d70553a5b83c))
* **cabinet-icons:** correct two mismatched glyphs from the svg migration ([9aae399](https://github.com/SayonaraQ/bedolaga-cabinet/commit/9aae399ce82b8bf95eb739e1406508f89a40b097))
* **cabinet:** blocking screens exit via the native Telegram back button, drop the in-page Close ([f9cc70c](https://github.com/SayonaraQ/bedolaga-cabinet/commit/f9cc70cba32debc8edb300869ba652b93f774212))
* **cabinet:** equal-height StatCards so dashboard balance/referral align ([1a3236f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1a3236f6506ffba87d65308a99b4cc0653b0d0ad))
* **cabinet:** harden global encoders against lone UTF-16 surrogates ([d37872f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/d37872fd4fa80d781377fc2b2169b3af22b77394))
* **cabinet:** Lava top-up return route + Telegram-unavailable card overflow ([d7f7bc7](https://github.com/SayonaraQ/bedolaga-cabinet/commit/d7f7bc7c173817812193aa00b5b2215d2c87159b))
* **cabinet:** recover "Сервис недоступен" false-positive + top-up fixes ([16fad9f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/16fad9f4feae4323c181f8a3c1bb33e13071f82b))
* **cabinet:** stop long user data overflowing flex rows on mobile ([63863a0](https://github.com/SayonaraQ/bedolaga-cabinet/commit/63863a048bf71793f08a560b26bb41cc3a24bdba))
* **cabinet:** sweep mobile flex-overflow across all pages + components ([800daf7](https://github.com/SayonaraQ/bedolaga-cabinet/commit/800daf7506c1c1d1718971d672a8fabb38dfa8e8))
* **chrome:** replace 2 platform emoji + 1 en-dash with on-brand tokens ([5784efd](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5784efd7a3d6aa789b16282c8c04259466363a37))
...
* **connected-accounts:** guide the user to enter the existing account's password when merging by email ([7d31dc3](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7d31dc3ffa094683c17b81dbf0ee8a555a34da09))
* **connected-accounts:** keep status/unlink inside the card on long IDs ([c39c164](https://github.com/SayonaraQ/bedolaga-cabinet/commit/c39c164d51fac8616b994f87ba8bc027a4bf0726))
* **connected-accounts:** stack status + unlink so the full ID shows on mobile ([7383505](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7383505a127efc11b166d307eb2f06e1a70972e0))
* **connection:** Happ TV connect renders through the active block style (all 4) ([c91c9e0](https://github.com/SayonaraQ/bedolaga-cabinet/commit/c91c9e0441232109398798d4c42711b1c897b5ed))
* **connection:** Happ TV connect works on Apple TV too (one API for both) ([ce7a3ea](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ce7a3eaedf4127129de2b2aec3dea85bd9fe48b1))
* **connection:** Happ TV quick-connect is Happ-only + matches config-block styles ([5855a88](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5855a88dc630924ea3e047ccb9cc85e578532b08))
* **connection:** keep selected app when switching platform ([f8ac489](https://github.com/SayonaraQ/bedolaga-cabinet/commit/f8ac4895fa7def88d2e2905a8df57726f85aa048))
...
* **connection:** restrict Happ TV quick-connect to Android TV only ([ca54cb4](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ca54cb4732ee30cc18a851cd8a6b8b2301194014))
* **connection:** stop ERR_UNKNOWN_URL_SCHEME when opening app deep links on mobile ([325e221](https://github.com/SayonaraQ/bedolaga-cabinet/commit/325e221e3209b430a7f5fd95df325802dae5db97))
...
* **dashboard:** убрать дубль кнопки покупки при пустом списке подписок ([cecfe7e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/cecfe7ec038a26eb580404957e70859e0df27e26))
* **datepicker:** убрать скачки и поправить адаптив ([c880517](https://github.com/SayonaraQ/bedolaga-cabinet/commit/c8805171693ec4070b9f9bc9b194b4ee91d971fa))
* **datepicker:** читаемость календаря в любой теме ([a8213ce](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a8213ce5d5fccd24ee192196a52accbf65954984))
* **decoration:** strip 4 accent / status-hue leaks across hero surfaces ([75f7750](https://github.com/SayonaraQ/bedolaga-cabinet/commit/75f775064cfe50a140663b1498429a3f330b91da))
* **deeplink:** поддержать схему incy:// в редиректе добавления подписки ([488503b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/488503b360806def859e7792919b68ab29ae44e1))
* **desktop-header:** full-width row so all nav items fit (no overflow/overlap) ([864aeaf](https://github.com/SayonaraQ/bedolaga-cabinet/commit/864aeaf600eb3af20f700af2c68f6570abbf1115))
* **desktop-header:** stop layout jumping via 3-column grid ([9fc681b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/9fc681b56da18c1453bc2e034d306019c454c771))
...
* **favicon:** скругляем углы кастомного лого как у плитки в хедере ([7104778](https://github.com/SayonaraQ/bedolaga-cabinet/commit/71047780c96b72fe6af3bfca86e8e3b30eb2be9c))
* **flags:** render flag emoji on Windows globally via a scoped flag font ([b877d7f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b877d7f17550aff9157e662af0525653ab764a0f))
...
* **gift:** cabinet GiftResult shows claim link for directed gifts + review fixes ([b9521f1](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b9521f1aa73758ad61d0d0be4686676c051dbe17))
* **gift:** stretch my-gifts cards full-width instead of cramped 2-col grid ([50d7d21](https://github.com/SayonaraQ/bedolaga-cabinet/commit/50d7d2146296a30027306b02e01ce4177dc210e3))
* **gift:** working bot deep-link + desktop layout + barrel icons ([6ea7672](https://github.com/SayonaraQ/bedolaga-cabinet/commit/6ea767253f88796f50a9e0aad8d5363033a0fba3))
...
* guard decodeURI(Component) against lone-surrogate crash ([#667225](https://github.com/SayonaraQ/bedolaga-cabinet/issues/667225)) ([81581f5](https://github.com/SayonaraQ/bedolaga-cabinet/commit/81581f5c9bdf119afb43e1b1d74ebcfa9934b86c))
...
* **i18n,a11y:** sync &lt;html lang&gt; + dir with i18n language ([28c6825](https://github.com/SayonaraQ/bedolaga-cabinet/commit/28c682500ca84bba214c1b7d60868fac5ea33346))
* **i18n:** backfill 120 missing keys + close 2 typo regressions from purchase refactor ([e1f401c](https://github.com/SayonaraQ/bedolaga-cabinet/commit/e1f401c333b992ab6476206fb231b608f8f20646))
* **i18n:** spell the brand "Remnawave" instead of camelCase "RemnaWave" ([0d024ae](https://github.com/SayonaraQ/bedolaga-cabinet/commit/0d024aec58919882478da773083c93888ce23a00))
...
* **landing-stats:** guard gift claim-rate against stale cache (avoid NaN%) ([b210a04](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b210a04dbb772fe1faf66f02b6ef6db447e9766e))
* **landing:** заголовок «Loading...» и пустая иконка вкладки на лендингах ([5a6e458](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5a6e4589c866a168656285deae214f178491cb12))
...
* **navigation:** break BackButton loop on single-tariff /subscriptions/:id deep-link ([3c2f650](https://github.com/SayonaraQ/bedolaga-cabinet/commit/3c2f650c28a7a47b12dcc19197cf1a6dd46f2b03))
* **navigation:** make Telegram back button work on deep-link entry ([2bcba3b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/2bcba3b60f883afc5fbad980fd067b0939a32069))
* **navigation:** single-tariff /subscriptions/:id deep-link shows Close, not Back ([0ed8bb1](https://github.com/SayonaraQ/bedolaga-cabinet/commit/0ed8bb1d48918d7a441043b035c8cd0721f6c515))
* **navigation:** single-tariff subscription detail всегда Close, не Back ([ec346d3](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ec346d38d8e74a8efade19ac234c2f2261819747))
* **navigation:** надёжная кнопка «Назад» через тип навигации, без петли ([#436](https://github.com/SayonaraQ/bedolaga-cabinet/issues/436)) ([a62d689](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a62d689fd39bea727b1bc9b13421775ca3a9c9a8))
* **nav:** keep Support pinned in mobile bottom-nav ([68a97b8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/68a97b896b4bc845bae49cf199198ca3d55a1ab3))
* **news:** fill the orphan card so the grid has no empty cell ([7b7ff53](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7b7ff536729872bc4b107bb4ce19a1643d979ca5))
* **payment-labels:** добавить лейбл OverPay (показывался сырым ключом) ([33f8dda](https://github.com/SayonaraQ/bedolaga-cabinet/commit/33f8ddac9a17047766ff924cefddf0e83e689cbf))
...
* **payments:** open_url_direct payment URL opens externally in Telegram ([#654272](https://github.com/SayonaraQ/bedolaga-cabinet/issues/654272)) ([ce5737f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ce5737fcbc44030595c0dc7a3cfda92e19aa2dbf))
* **permission-route:** guard against /admin → /admin redirect loop ([62eaef2](https://github.com/SayonaraQ/bedolaga-cabinet/commit/62eaef2f539a33bf92d06c78421628f98974faaf))
* **profile,connected-accounts:** drop dead ['user'] invalidate calls ([23e4e9b](https://github.com/SayonaraQ/bedolaga-cabinet/commit/23e4e9b4d1854ce8f8ade8dd24249a5bdd232d2a))
* **promocode:** correct activation UX, error mapping and validity dates ([35428cc](https://github.com/SayonaraQ/bedolaga-cabinet/commit/35428cc27d45335c11b8999391bd8a388090fe7b))
...
* **prose:** keep TipTap list markers inline with their content ([ed0b46e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ed0b46e833d5d4bf8a1f94f2564890c6bab93f03))
...
* **reset-password:** cancel post-success redirect timer on unmount ([3f7320f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/3f7320fb4d6910c6d5f452a62699656ec9d3549c))
* **routing:** give every lazy page its own ErrorBoundary ([87e2e82](https://github.com/SayonaraQ/bedolaga-cabinet/commit/87e2e82136785d4dc25c9052cb122ee4812f8034))
* **sales-stats:** «Выручка» → «Оборот по подпискам» во вкладке Продажи ([40c684c](https://github.com/SayonaraQ/bedolaga-cabinet/commit/40c684cc8887df8ec6e2287939141a975e4aacbc))
* **sales-stats:** адаптив сетки Допов и сводки ([56d8e1f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/56d8e1ffa760558c0196cf1069a5696fe03dd0c9))
* **sales-stats:** крупные суммы сводки без копеек (короче, не режет) ([a687cc3](https://github.com/SayonaraQ/bedolaga-cabinet/commit/a687cc3d1878eb22e12129e20b4e60158d62bfd2))
* **sales-stats:** не резать значения в карточках сводки (адаптив) ([631e922](https://github.com/SayonaraQ/bedolaga-cabinet/commit/631e922f785bfaa0db396ea19df0dac886e2eb5b))
* **sales-stats:** ровные иконки в карточках + не дублировать иконку ([622ec31](https://github.com/SayonaraQ/bedolaga-cabinet/commit/622ec318da6eac1cef92c95f244159825345a5e1))
* **sales-stats:** убрать пустые ячейки в сетках карточек ([54998c8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/54998c819566b749c282a5f20ab383469f2615ba))
...
* **scope-selector:** drop role=dialog from non-modal popover (a11y) ([bef984d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bef984d72a534ac4296eaaf30e3cc01eb216e89e))
* **security:** extract & reuse getSafeRedirectPath, plug TopUpAmount returnTo ([424a193](https://github.com/SayonaraQ/bedolaga-cabinet/commit/424a19344dcfe0bbd8116a021283f67657dd0ca2))
...
* **security:** use signed media tokens for ticket attachments ([c6fc167](https://github.com/SayonaraQ/bedolaga-cabinet/commit/c6fc167d80898832504000c24860be8c4099fb93))
* **security:** validate the deep-link url in miniapp/redirect.html (open redirect + DOM-XSS) ([b4f0669](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b4f066942a613027d8a9c347332ef1efdd29e03d))
...
* **stats-charts:** убрать focus-outline артефакт при клике по графику ([5e83762](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5e837621ad5649b8c6d78d74218cbee2258d0f2b))
...
* **subscription:** clear critique P0 + P1 + part of P2 ([312a34f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/312a34f7159be3a836865a5120a7cc6f0640f699))
...
* **subscriptions:** «+ Купить ещё» только при платной подписке, явный CTA покупки ([39bfef5](https://github.com/SayonaraQ/bedolaga-cabinet/commit/39bfef58d0db9ebbe2bd27d4e7f327f02932b81b))
* **subscriptions:** fill the orphan card so a lone subscription has no empty cell ([484c3ad](https://github.com/SayonaraQ/bedolaga-cabinet/commit/484c3ad005616e16fc4280284048dcf674551057))
* **subscriptions:** дать новым юзерам путь в витрину без активации триала ([2d5982d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/2d5982d82bf8c47f13e07b230a800653d1eeed60))
* **subscription:** use the nav sparkle icon on the renew CTA button ([8613cb2](https://github.com/SayonaraQ/bedolaga-cabinet/commit/8613cb20aa585c24e5d5e99f64e8b82efbbd8915))
* **subscription:** use the nav SubscriptionIcon on the quick-renew button ([5340f81](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5340f81a9562ad83a0a101d9f550ee30cf507622))
* **subscription:** use the sparkle icon on the quick-renew button ([e18db02](https://github.com/SayonaraQ/bedolaga-cabinet/commit/e18db02e42214c8b2f6f54813815173417286134))
...
* **switch-tariff:** route trial & expired subs to the purchase flow ([#629889](https://github.com/SayonaraQ/bedolaga-cabinet/issues/629889)) ([5b123f5](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5b123f5da034f22ed8d59700cf60d79213d4ea8c))
...
* **telegram-redirect:** cancel pending timers on effect re-run/unmount ([748b051](https://github.com/SayonaraQ/bedolaga-cabinet/commit/748b0514ea6cba6424cd3054d93c201693ee7344))
...
* **theming:** replace off-token TelegramCallback/VerifyEmail with design tokens ([feee9f9](https://github.com/SayonaraQ/bedolaga-cabinet/commit/feee9f9c05b2f872173ef6d4951bf2db8065514a))
...
* **toast:** drop side-stripe ban + a11y polish ([eaaf5cf](https://github.com/SayonaraQ/bedolaga-cabinet/commit/eaaf5cfebbf90b9974712ae29f3a0334b6a08696))
* **traffic:** correct misleading add-traffic note — 30-day validity ([f7bd36a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/f7bd36a95e27d9d9257fbfb45f23513b05a6b017))
...
* **wheel:** keep spin sparkles in the outer ring, never near the centre ([6c5d1ee](https://github.com/SayonaraQ/bedolaga-cabinet/commit/6c5d1ee0b1cfb3329580879ce6b4be1c6c6a69ec))
* **wheel:** kill the center-line LED artifact during spin (drop CSS blur filter) ([8a41aa7](https://github.com/SayonaraQ/bedolaga-cabinet/commit/8a41aa77819d141bc3e6cb6b481e2420b11f391e))
* **wheel:** remove CSS filters from the spinning SVG (kill GPU-composite streak) ([2ce966c](https://github.com/SayonaraQ/bedolaga-cabinet/commit/2ce966cecec1c3a9634814cb1fb89a43d7ab63d9))
* **wheel:** remove the spin-only sparkle lights entirely ([bc85034](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bc8503469dc6651accb77f41b865e443849b75f2))
* **wheel:** scatter spin sparkles so they don't streak through the centre ([7716e32](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7716e32eecea6e43264342635090d8e4f68e4d87))
* **wheel:** stop showing fake wins in the browser ([73ee42a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/73ee42a0ef38ec36ff6f763304b9521e44d9302a))


### Performance Improvements

* **admin-bulk-actions:** migrate users + 4 lookup loaders to React Query ([bc5e95a](https://github.com/SayonaraQ/bedolaga-cabinet/commit/bc5e95a6e55af44fa96f22facf4becee1e17131e))
* **admin-panel:** migrate system info + stats poll to React Query ([7426e1e](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7426e1e6d14a43f269c976954d33dece7c2ec19e))
* **admin-traffic:** migrate data flow to React Query ([2214d7f](https://github.com/SayonaraQ/bedolaga-cabinet/commit/2214d7fdabb9bc1df9754627638b6ba16d5cf10b))
* **admin-user-detail:** migrate remaining 9 leaf loaders to React Query ([6f7bd10](https://github.com/SayonaraQ/bedolaga-cabinet/commit/6f7bd10d61dc77b7bb9b035238df38c1001bbdf6))
* **admin:** migrate AdminBanSystem tab fetching to React Query ([1e4d6da](https://github.com/SayonaraQ/bedolaga-cabinet/commit/1e4d6dad47ff4030d88a6594fa364513f6ada3d7))
* **admin:** migrate AdminDashboard to React Query (refetchInterval, no setInterval) ([0b07af8](https://github.com/SayonaraQ/bedolaga-cabinet/commit/0b07af82d4e1c28f8153fb5bb44a5cc10627a1ad))
* **admin:** migrate AdminUserDetail loadUser to React Query (caching + cache key) ([5ee97e0](https://github.com/SayonaraQ/bedolaga-cabinet/commit/5ee97e0a9f48fea1b267947c93c0d29585b59a43))
* **admin:** migrate AdminUsers fetch to React Query ([dadf08d](https://github.com/SayonaraQ/bedolaga-cabinet/commit/dadf08d005cca5e22056ddef3e55106d646fc04f))
* **build:** split recharts + tiptap into dedicated vendor chunks ([7f14c49](https://github.com/SayonaraQ/bedolaga-cabinet/commit/7f14c499ad61a7e74be638e5ca920c9951a3a01c))
* **images:** add loading=lazy to in-list previews and attachments ([b6613ae](https://github.com/SayonaraQ/bedolaga-cabinet/commit/b6613ae4c92eb8ea02bf0375d419d6a510ddee99))
* **motion:** convert layout-property transitions to transforms ([eb13689](https://github.com/SayonaraQ/bedolaga-cabinet/commit/eb13689ae79f9baddf973c1dc0a744913490f535))


### Reverts

* **sales-stats:** убрать карточки возвратов из сводки ([ec23618](https://github.com/SayonaraQ/bedolaga-cabinet/commit/ec23618a56f0e1da3b140d2983edf10768000e30))
